...
export const RegistrationTable: React.FC = () => {
  const { t } = useTranslation();
  const [currentPageSize, setCurrentPageSize] = useState<number>(10);

  const RegistrationWorkListEntries = [
    {
      name: "John Doe",
      date: "2024-03-25",
  ...
  const searchResults = RegistrationWorkListEntries.filter(() => {
          ...
          <>
            <TableContainer {...getTableContainerProps()}>
              ...
              <Pagination
                ...
                pageSizes={pageSizes}
                totalItems={RegistrationWorkListEntries.length}

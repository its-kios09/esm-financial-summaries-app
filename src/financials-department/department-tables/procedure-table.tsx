...
export const ProceduresTable: React.FC = () => {
  ...
  const ProceduresWorkListEntries = [
    {
      name: "John Doe",
      date: "2024-03-25",
      procedures: "Wound and Dressing",
      id: "P123",
      category: "Paying",
      sub: "General patient",
      waiver: 0,
  ...
  const searchResults = ProceduresWorkListEntries.filter(() => {
  ...
  const tableColumns = [
    ...
    {
      id: 1,
      header: t("procedures", "PROCEDURES PREFORMED"),
      key: "procedures",
    },
          ...
          <>
            <TableContainer {...getTableContainerProps()}>
              ...
              <Pagination
                ...
                pageSizes={pageSizes}
                totalItems={ProceduresWorkListEntries.length}

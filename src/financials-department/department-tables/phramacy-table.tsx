...
export const PharmacyTable: React.FC = () => {
  ...
  const PharmacyWorkListEntries = [
    {
      name: "John Doe",
      date: "2024-03-25",
      drug: "Tramadol INJ 1ml",
      id: "P123",
      category: "Paying",
      sub: "General patient",
      waiver: 0,
  ...
  const searchResults = PharmacyWorkListEntries.filter(() => {
    return true;
  });
  ...
  const tableColumns = [
    ...
    { id: 1, header: t("drug", "DRUGS DISPENSED"), key: "drug" },
          ...
          <>
            <TableContainer {...getTableContainerProps()}>
              ...
              <Pagination
                ...
                pageSizes={pageSizes}
                totalItems={PharmacyWorkListEntries.length}

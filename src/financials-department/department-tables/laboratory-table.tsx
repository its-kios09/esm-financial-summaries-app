...
export const LaboratoryTable: React.FC = () => {
  const { t } = useTranslation();
  const [currentPageSize, setCurrentPageSize] = useState<number>(10);

  const LaboratoryListEntries = [
    {
      name: "John Doe",
      date: "2024-03-25",
      labtest: "Rapid Test Malaria",
      id: "P123",
      category: "Paying",
      sub: "General patient",
      waiver: 0,
  ...
  const searchResults = LaboratoryListEntries.filter(() => {
  ...
  const tableColumns = [
    ...
    { id: 1, header: t("labtest", "LABORATORY TEST DONE"), key: "labtest" },
          ...
          <>
            <TableContainer {...getTableContainerProps()}>
              ...
              <Pagination
                ...
                pageSizes={pageSizes}
                totalItems={LaboratoryListEntries.length}

...
export const SpecialClinicTable: React.FC = () => {
  const { t } = useTranslation();
  const [currentPageSize, setCurrentPageSize] = useState<number>(10);

  const SpecialClinicWorkListEntries = [
    {
      name: "John Doe",
      date: "2024-03-25",
      service: "MOPC Registration Fee",
      id: "P123",
      category: "Paying",
      sub: "General patient",
      waiver: 0,
  ...
  const searchResults = SpecialClinicWorkListEntries.filter(() => {
  ...
  const tableColumns = [
    ...
    { id: 1, header: t("service", "SERVICE OFFERED"), key: "service" },
          ...
          <>
            <TableContainer {...getTableContainerProps()}>
              ...
              <Pagination
                ...
                pageSizes={pageSizes}
                totalItems={SpecialClinicWorkListEntries.length}
